...
def partition_classes(X, y, split_attribute, split_val):
    ...
    # For example, split_val could be the mean of the values of split_attribute
    # If the split attribute is categorical, split_val should be one of the categories.   
    #
    # You can perform the partition in the following way
    # Numeric Split Attribute:
    #   Data X is splitted into two lists(X_left and X_right) where the first list has all
    #   the rows where the split attribute is less than or equal to the split value, and the 
    #   second list has all the rows where the split attribute is greater than the split 
    #   value. Also two lists(y_left and y_right) are created with the corresponding y labels.
    #
    # Categorical Split Attribute:
    #   Data X is splitted into two lists(X_left and X_right) where the first list has all 
    #   the rows where the split attribute is equal to the split value, and the second list
    #   has all the rows where the split attribute is not equal to the split value.
    #   Also Two lists(y_left and y_right) are created with the corresponding y labels.
    ...
    A case is considered where we call the function with split_attribute = 0 and split_val = 3 (mean of column 0)
    ...
    Another case is considered where we call the function with split_attribute = 1 and split_val = 'bb'
...
def information_gain(previous_y, current_y):
    ...
    # TODO: eInformation gain is computed and returned from partitioning the previous_y labels
    # into the current_y labels.
    # entropy function given above above is used to compute information gain
